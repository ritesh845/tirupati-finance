			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						{{Form::select('vehicle_type',VEHICLETYPE,old('vehicle_type'),['class'=>'form-control','placeholder'=>'Select Vehicle Type'])}}
						@error('vehicle_type')
					...
					<div class="col-md-6 form-group">
						...
						{{Form::input('text','interest',old('interest'),['class'=>'form-control','placeholder'=>'','readonly' => 'readonly'])}}
						@error('interest')
					        <span class="text-danger" role="alert">
					            <strong>{{ $message }}</strong>
					        </span>
					...
					<div class="col-md-6 form-group">
						...
						{{Form::input('text','finance_amount',old('finance_amount'),['class' => 'form-control','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
