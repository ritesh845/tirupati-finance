	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				Loan Create
				<a href="{{route('client.show',$client->id)}}" class="btn btn-sm btn-primary pull-right ml-2"><i class="fa fa-angle-left"></i> Back</a>	
			</div>
			<div class="card-body">
				{{Form::open(array('route' => 'loan.submit', 'method' => 'post'))}}			
				<div class="row">
					<div class="col-md-6 form-group">
						{{Form::label('financer_name','Financer Name',['class'=>'required'])}}
						{{Form::input('text','financer_name',old('financer_name'),['class'=>'form-control','placeholder'=>'Financer Name'])}}
						@error('financer_name')
					...
					<div class="col-md-6 form-group">
						...
						{{Form::input('text','hirer_name',old('hirer_name') ?? $client->name,['class'=>'form-control','placeholder'=>'Hirer Name','required'=>'required'])}}
						@error('hirer_name')
					        <span class="text-danger" role="alert">
					            <strong>{{ $message }}</strong>
					        </span>
					...
					<div class="col-md-6 form-group">
						...
						{{Form::input('text','make',old('make'),['class'=>'form-control','placeholder'=>'Make'])}}
						@error('make')
					        <span class="text-danger" role="alert">
					            <strong>{{ $message }}</strong>
					        </span>
					...
					<div class="col-md-6 form-group">
						...
						{{Form::select('vehicle_type',VEHICLETYPE,old('vehicle_type') ?? '1',['class'=>'form-control','placeholder'=>'Select Vehicle Type'])}}
						@error('vehicle_type')
					        <span class="text-danger" role="alert">
					            <strong>{{ $message }}</strong>
					        </span>
