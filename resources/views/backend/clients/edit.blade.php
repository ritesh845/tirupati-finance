...
<div class="row">	
	<div class="col-md-12">
		<div class="card">
			...
			{{Form::open(array('url' => 'client/'.$client->id, 'method' => 'post','enctype' => 'multipart/form-data'))}}
			@method('patch')
			<div class="card-body">	
				    ...
				    <div id="basic_details" class="container tab-pane active">
				    	<div class="row ">
				    	   	<div class="col-md-6 form-group">
								...
								{{Form::input('text','name',old('name') ?? $client->name,['class'=>'form-control','placeholder'=>'Client Name','required'=>'required'])}}
								@error('name')
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','father_name',old('father_name') ?? $client->father_name,['class'=>'form-control','placeholder'=>'Father Name','required'=>'required'])}}
								@error('father_name')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','aadhar_card',old('aadhar_card') ?? $client->aadhar_card,['class'=>'form-control','placeholder'=>'Enter Aadhar Card','required' => 'required','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
								@error('aadhar_card')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('email','email',old('email') ?? $client->email,['class'=>'form-control','placeholder'=>'Client Email'])}}
								@error('email')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','mobile',old('mobile') ?? $client->mobile,['class'=>'form-control','placeholder'=>'Mobile Number','readonly'=>'readonly','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
								@error('mobile')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','mobile1',old('mobile1') ?? $client->mobile1,['class'=>'form-control','placeholder'=>'Alternate Mobile Number','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
								@error('mobile1')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								{{Form::label('age','Age')}}
								{{Form::input('text','age',old('age') ?? $client->age,['class'=>'form-control','placeholder'=>'Enter Age','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
								@error('age')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::select('cast_category',CAST,old('cast_category') ?? $client->cast_category,['class'=>'form-control','placeholder'=>'Select Cast'])}}
								@error('cast_category')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','pan_card',old('pan_card') ?? $client->pan_card,['class'=>'form-control','placeholder'=>'Enter PAN Card Number'])}}
								@error('pan_card')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','address',old('address') ?? $client->address,['class'=>'form-control','placeholder'=>'Enter Address'])}}
								@error('address')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','zip_code',old('zip_code') ?? $client->zip_code,['class'=>'form-control','placeholder'=>'Enter Zip Code','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
								@error('zip_code')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','bussiness_year',old('bussiness_year') ?? $client->bussiness_year,['class'=>'form-control','placeholder'=>'Bussiness Year'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','office_name',old('office_name') ?? $client->office_name,['class'=>'form-control','placeholder'=>'Office Year'])}}
								@error('office_name')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','office_position',old('office_position') ?? $client->office_position,['class'=>'form-control','placeholder'=>'Office Year'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','office_id_card',old('office_id_card') ?? $client->office_id_card,['class'=>'form-control','placeholder'=>'Office Id Card'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','office_address',old('office_address') ?? $client->office_address,['class'=>'form-control','placeholder'=>'Office Address'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','monthly_income',old('monthly_income') ?? $client->monthly_income,['class'=>'form-control','placeholder'=>'Monthly Income'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','any_income_source',old('any_income_source') ?? $client->any_income_source,['class'=>'form-control','placeholder'=>'Any Income Source Name'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','bank_name',old('bank_name') ?? $client->bank_name,['class'=>'form-control','placeholder'=>'Bank Name'])}}
								@error('bank_name')
							        <span class="text-danger" role="alert">
							            <strong>{{ $message }}</strong>
							        </span>
				    		...
				    		<div class="col-md-6 form-group">
							    ...
							    {{$client->photo}}
							    	<img src="{{asset($client->photo)}}" style="width: 20px; height: 20px">
				     ...
				     <div id="guarantor_details" class="container tab-pane fade" >
				     	<div class="row">
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_name',old('guarantor_name')  ?? $client->guarantor_name,['class'=>'form-control','placeholder'=>'Guarantor Name'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_mobile',old('guarantor_mobile') ?? $client->guarantor_mobile,['class'=>'form-control','placeholder'=>'Guarantor Mobile','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_address',old('guarantor_address') ?? $client->guarantor_address,['class'=>'form-control','placeholder'=>'Guarantor Address'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_income',old('guarantor_income') ?? $client->guarantor_income,['class'=>'form-control','placeholder'=>'Guarantor Income'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_bussiness',old('guarantor_bussiness') ?? $client->guarantor_bussiness,['class'=>'form-control','placeholder'=>'Guarantor Bussiness'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_position',old('guarantor_position') ?? $client->guarantor_position,['class'=>'form-control','placeholder'=>'Guarantor Position'])}}
						...
						<div class="row" style="display: none" id="guarantor_another_row">
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_name1',old('guarantor_name1') ?? $client->guarantor_name1,['class'=>'form-control','placeholder'=>'Guarantor Name'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_mobile1',old('guarantor_mobile1') ?? $client->guarantor_mobile1,['class'=>'form-control','placeholder'=>'Guarantor Mobile','oninput' =>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_address1',old('guarantor_address1') ?? $client->guarantor_address1,['class'=>'form-control','placeholder'=>'Guarantor Address'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_income1',old('guarantor_income1') ?? $client->guarantor_income1,['class'=>'form-control','placeholder'=>'Guarantor Income'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_bussiness1',old('guarantor_bussiness1') ?? $client->guarantor_bussiness1,['class'=>'form-control','placeholder'=>'Guarantor Bussiness'])}}
							...
							<div class="col-md-6 form-group">
								...
								{{Form::input('text','guarantor_position1',old('guarantor_position1') ?? $client->guarantor_position1,['class'=>'form-control','placeholder'=>'Guarantor Position'])}}
